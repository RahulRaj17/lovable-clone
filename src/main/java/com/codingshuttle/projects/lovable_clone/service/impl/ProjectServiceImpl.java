...
//        projectRepository.findAllAccessibleByUser(userId).stream()
//                .map(projectMapper::toProjectSummaryResponse)
//                .collect(Collectors.toList());

        List<Project> listOfProjects = projectRepository.findAllAccessibleByUser(userId);
        return projectMapper.toListOfProjectSummaryResponse(listOfProjects);
    }
